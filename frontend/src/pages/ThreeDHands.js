...
const circularSize = maxSize * 1.047; // Adjust the scale as needed
...
loaderFBX1.load( 'two_hands_01.fbx', function ( object ) {

mask = object.children[ 0 ];
mask.position.set( 0, 0, 0 );
mask.scale.setScalar( 0.25 );
